...
from sources.compare.compare_utils import compare_all_inverted_and_save
...
def main():
    ...
    # Настройки пагинации
    START_PAGE = 16
    END_PAGE = 40  # Парсим страницы 1-10
    ...
    # Run comparison and save to database
    results = compare_all_inverted_and_save(price_delta_perc=1.1, clear_before=True)
    print(results)
